...
export const PageLayoutTopBar = (props: {
  ...
  return (
    <div
      className={cn(
        'z-10 flex min-w-0 flex-col items-center justify-end overflow-hidden border-b border-b-white/10 bg-white/5 pt-safe-top backdrop-blur-xl md:-mt-px md:[--page-layout-topbar-height:48px]',
        props.className
      )}
      style={{
